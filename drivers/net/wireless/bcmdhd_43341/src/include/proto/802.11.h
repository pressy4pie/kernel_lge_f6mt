 ...
 *
 * $Id: 802.11.h 391410 2013-03-18 06:11:13Z $
 */
...
#define DOT11_TFS_SUBELEM_LEN	2		/* Fixed length, include id and len */
...
#define DOT11_TFS_RESP_IE_LEN		1	/* Fixed length, only including tfs_id field */
...
#define DOT11_TFS_STATUS_SE_LEN		3	/* TFS Status Subelement length */
#define DOT11_TFS_STATUS_SE_DATA_LEN	1	/* TFS status Subelement Data length */
